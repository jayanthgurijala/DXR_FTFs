...
ID3D12DescriptorHeap* D3D12RaytracingSimpleLighting::GetOutputDescriptorHeap()
{
...
void D3D12RaytracingSimpleLighting::InitializeScene()
{
    ...
    // Setup materials.
    {
        m_cubeCB.albedo = XMFLOAT4(0.3f, 0.2f, 1.0f, 1.0f);
    }
...
void D3D12RaytracingSimpleLighting::CreateLocalRootSignatureSubobjects(CD3DX12_STATE_OBJECT_DESC* raytracingPipeline)
{
    ...
    // Local root signature to be used in a hit group.
    {
        ...
        rootSignatureAssociation->AddExport(c_cubeHitGroupName);
    }
...
void D3D12RaytracingSimpleLighting::CreateTestCase()
{
        ...
        FLOAT translateZ = 0.0f)
    {
        ...
        GetTransform3x4Matrix(&tlasDesc.transformMatrix, scaleX, scaleY, scaleZ, translateX, translateY, translateZ);
...
void D3D12RaytracingSimpleLighting::BuildAccelerationStructures()
{
    ...
    for (GeomDesc g : m_geomDescs)
    {
        ...
        {
            ComPtr<ID3D12Resource> indexBuffer = m_indexBuffer.resource;
            ComPtr<ID3D12Resource> vertexBuffer = m_vertexBuffer.resource;
...
void D3D12RaytracingSimpleLighting::BuildShaderTables()
{
    ...
    // Miss shader table
    {
        ...
        missShaderTable.push_back(ShaderRecord(missShaderShadowIdentifier, shaderIdentifierSize));
...
void D3D12RaytracingSimpleLighting::DoRaytracing()
{
    ...
    auto DispatchRays = [&](auto* commandList, auto* stateObject, auto* dispatchDesc)
    {
        ...
        dispatchDesc->HitGroupTable.StrideInBytes = m_hitGroupShaderStride;//dispatchDesc->HitGroupTable.SizeInBytes / 3;
...
{
    return new D3D12RaytracingSimpleLighting(width, height, L"Hello World");
}