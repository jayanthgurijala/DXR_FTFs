...
struct DxScreenShotBufferInfo
{
    D3D12_PLACED_SUBRESOURCE_FOOTPRINT      footPrint;
    Microsoft::WRL::ComPtr<ID3D12Resource>  m_stagingOutputResource;
    UINT width;
    UINT height;
    UINT numRows;
    UINT64 rowSize;
...
namespace DX
{
    ...
    public:
        ...
        static HRESULT SaveImage(char* szPathName, void* lpBits, int w, int h);
        ...
        DxScreenShotBufferInfo*     GetScreenShotBufferInfo() { return &m_screenshotBufferInfo; }
    ...
    private:
        ...
        DxScreenShotBufferInfo                              m_screenshotBufferInfo;
